...
const faqs = [
  {
    question: "How does Saila work as an AI phone call platform?",
    answer: "Saila automates customer interactions with customizable AI voice agents that can scale. It manages outbound (proactive outreach) and inbound (responsive) calls for tasks like lead qualification, customer support, and appointment scheduling. With no-code tools and flexible deployment options, Saila enhances engagement and streamlines communication using the latest AI technology.",
  },
  {
    question: "Can I use Saila with my existing phone system?",
    answer: "Yes, Saila can integrate with most existing phone systems through SIP trunking, ensuring a smooth transition while maintaining your current functionality. We also offer dedicated phone numbers from over 150 countries if you need new numbers.",
  },
  {
  ...
  },
  {
    ...
    answer: "Saila supports over 100 languages with hundreds of natural-sounding voice options for each. You can choose from different accents, genders, and speaking styles. We also offer voice cloning technology to create custom brand voices.",
  },
  {
  ...
  },
  {
    ...
    answer: "Absolutely. Saila seamlessly transfers calls to human agents when the situation requires it or when customers request to speak with a person. You can configure custom transfer rules based on keywords, sentiment, or specific scenarios.",
  },
  {
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          >
            ...
            <p className="text-lg text-neutral-600 mb-8">
              Everything you need to know about Saila. Can't find what you're looking for?
            </p>
