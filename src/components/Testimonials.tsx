...
const testimonials = [
  {
    ...
    content: "Saila has transformed our customer support. We now handle 3x more calls with the same team size, and our customer satisfaction scores have never been higher.",
    rating: 5,
    avatar: "SC",
  },
  {
    ...
    content: "The appointment scheduling feature alone has saved us countless hours. Our no-show rate dropped by 40% since implementing Saila's reminder calls.",
    rating: 5,
    avatar: "MR",
  },
  {
    ...
    content: "Our sales team can now focus on closing deals instead of cold calling. Saila qualifies leads for us and only sends us the most promising prospects.",
    rating: 5,
    avatar: "EW",
  },
  {
  ...
  },
  {
    name: "James Wilson",
    role: "CTO, FinanceHub",
    content: "Enterprise-grade security was crucial for us. Saila's compliance features made it easy to meet all our regulatory requirements.",
    rating: 5,
    avatar: "JW",
  },
];
      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <p className="text-lg text-neutral-600">
            See how companies are transforming their customer communications with Saila.
          </p>
        </motion.div>
